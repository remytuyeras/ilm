...
def create_logo(output_path, text="I L M", font_size=100, width=500, height=200, font_path=None, add_shadow=True):
    ...
    start_color = (200, 50, 50)  # Teal (start)
    delta = 15
    end_color = (188-delta, 26+delta, 156+delta)  # Slightly lighter for contrast
